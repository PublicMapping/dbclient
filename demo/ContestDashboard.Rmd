  ...
  ui <- fluidPage(
    sidebarLayout(
      sidebarPanel(
        ...
        selectInput("crit_2", "Second Criteria", scoreVars), # TODO: dynamically remove first criteria
  ...
  server <- function(input, output) {
    ...
    output$Tradeoffs <- renderPlotly({
        p1 <- filtered.tb() %>% 
          ...
          geom_point() + 
          geom_text(aes(alpha=.0001,size=1,lineheight=0)) +
  ...
  ui <- fluidPage(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        tags$br(),
        tags$hr(),
        selectInput("comparison_plan", "Comparison plan", planlist), # TODO: dynamically remove primary plan
        # withTags({
        #   br()
