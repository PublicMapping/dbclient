              ...
              sidebarLayout(
                ...
                mainPanel(
                  tabsetPanel(type = "tabs",
                              tabPanel("Score Tradeoffs ", plotlyOutput("Tradeoffs") #,
                                       #textOutput("Selection") # TODO: send selection to other panels
                                       ),
                              tabPanel("Score Distributions", plotOutput("Distributions")) 
                  ),
