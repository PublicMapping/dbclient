...
refresh_checkpoint <- function(checkpoint=GLOBALS$checkpoint) {
  ...
  tmpmeta <- db2meta(contestPlans.tb$id,targetdir=GLOBALS$plan_dir, retrieve=FALSE)
  contestPlans.tb %<>% inner_join(tmpmeta,by=c("id"="plan_id")) # this drops plans that weren't retreiveable
  contestPlans.sflist <- db2sf(contestPlans.tb$id,targetdir=GLOBALS$plan_dir, retrieve=FALSE)
